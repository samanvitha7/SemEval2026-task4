#!/bin/bash
#SBATCH --job-name=semeval_predict
...
# Run ensemble predictions for Track A
.venv/bin/python predict.py --test_file data/test.jsonl --output_file output_track_a.jsonl --use_ensemble

# Run ensemble predictions for Track B
.venv/bin/python predict.py --test_file data/testb.jsonl --output_file output_track_b.jsonl --use_ensemble
